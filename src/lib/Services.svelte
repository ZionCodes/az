...
<div class="max-w-[85rem] px-4 my-10 sm:px-6 lg:px-8 lg:py-14 mx-auto bg-gray-900" use:inview={options} on:inview_change={handleChange}>
  {#if isInView}
      <div class="max-w-3xl mb-10 lg:mb-14" transition:fly={{ y: 200, duration: 1000, delay: 1000 }}>
        ...
        <p class="mt-1 text-neutral-400">We create custom automation solutions that simplify workflows, boost efficiency, and save time. Let’s transform your business processes for enhanced productivity.</p>
      </div>
      <!-- End Title -->
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6" transition:fly={{ y: 200, duration: 2000, delay: 1000 }}>
          <!-- Card -->
          <a class="hover:scale-110 group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-gray-800 dark:focus:bg-gray-800" href="#">
          ...
          <a class="hover:scale-110 group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-gray-800 dark:focus:bg-gray-800" href="#">
            ...
            <div>
              <div>
                ...
                <p class="text-gray-600 dark:text-neutral-400">Gain valuable insights from your data. We help you analyze and visualize key metrics to make data-driven decisions that drive growth and improve performance.</p>
              </div>
          ...
          <a class="hover:scale-110 group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-gray-800 dark:focus:bg-gray-800" href="#">
            ...
            <div>
              <div>
                ...
                <p class="text-gray-600 dark:text-neutral-400">Work with our experts to develop actionable strategies for improving your workflows, implementing automation, and achieving your business goals.</p>
              </div>
          ...
          <a class="hover:scale-110 group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-gray-800 dark:focus:bg-gray-800" href="#">
            ...
            <div>
              <div>
                ...
                <p class="text-gray-600 dark:text-neutral-400">After implementation, we provide continuous support to optimize your systems and ensure they grow and evolve with your business.</p>
              </div>
