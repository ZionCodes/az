...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto bg-gray-900" use:inview={options} on:inview_change={handleChange}>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-3 lg:gap-6">
        <div class="p-4 md:p-7 bg-gray-800 rounded-lg hover:scale-110 flex justify-center items-center" transition:scale={{ duration: 1000, delay: 1000 }}>
            <img src={airtable} alt="Description" class="w-12 h-12 object-contain mr-4" />
            <span class="text-white text-lg">Airtable</span>
        </div>
        <div class="p-4 md:p-7 bg-gray-800 rounded-lg hover:scale-110 flex justify-center items-center" transition:scale={{ duration: 1000, delay: 1000 }}>
            <img src={make} alt="Description" class="w-12 h-12 object-contain mr-4" />
