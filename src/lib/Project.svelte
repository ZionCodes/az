<div class="flex flex-col items-center mx-auto gap-y-4 mt-16 mb-16">
    <a class="group block w-full max-w-3xl rounded-xl overflow-hidden focus:outline-none border border-gray-700" href="#">
    ...
    <a class="group block w-full max-w-3xl rounded-xl overflow-hidden focus:outline-none border border-gray-700" href="#">
        <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
          <div class="shrink-0 relative rounded-xl overflow-hidden w-full sm:w-56 h-44">
            <img class="group-hover:scale-105 group-focus:scale-105 transition-transform duration-500 ease-in-out size-full absolute top-0 start-0 object-cover rounded-xl" src="https://images.unsplash.com/photo-1540575861501-7cf05a4b125a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=320&q=80" alt="Blog Image">
          </div>
