<script lang="ts">
  ...
  <div
    class="w-full bg-gray-900 font-sans md:px-10"
    bind:this={containerRef}
  >
    <div class="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
      <h2 class="text-2xl md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
        Approach
      </h2>
      <p
        class="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm"
      >
      Here’s how I design and build efficient and scalable systems that grow with your business.
      </p>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto pb-20 overflow-hidden">
      ...
      class="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-[#ff0] via-[#ff0] to-transparent from-[0%] via-[10%] rounded-full"
    ></div>
      </div>
    </div>
  </div>
