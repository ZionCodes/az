...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto bg-gray-900" use:inview={options} on:inview_change={handleChange}>
  ...
  <div class="max-w-3xl mb-10 lg:mb-14" transition:fly={{ y: 200, duration: 1000, delay: 1500 }}>
    <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">Case Studies</h2>
    <p class="mt-1 text-neutral-400">Real examples of how I’ve helped businesses automate processes, optimize workflows, and improve performance.</p>
  </div>
  <!-- End Title -->
    <!-- Grid -->
